...
<a title="${value.description}" href="/starexec/secure/details/benchmark.jsp?id=${value.id}" target="_blank">${value.name}<img class="extLink" src="/starexec/images/external.png"/></a>