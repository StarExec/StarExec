...
<a title="${value.description}" href="/starexec/secure/details/configuration.jsp?id=${value.id}" target="_blank">${value.name}<img class="extLink" src="/starexec/images/external.png"/></a>