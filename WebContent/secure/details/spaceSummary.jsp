			...
			<table id="solveTbl" class="shaded">
				...
				<tbody>
					<c:forEach var="cs" items="${stats}">
						<tr id="statRow">
							<td><a href="/${starexecRoot}/secure/details/pairsInSpace.jsp?id=${s.id}&configid=${cs.configuration.id}&sid=${space.id}" target="_blank">${cs.solver.name}<img class="extLink" src="/${starexecRoot}/images/external.png"/></a></td>
