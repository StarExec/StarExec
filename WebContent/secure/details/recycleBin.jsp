...
<star:template title="Personal Recycle Bin" js="common/delaySpinner, details/recycleBin, lib/jquery.dataTables.min, lib/jquery.cookie, lib/jquery.jstree, lib/jquery.qtip.min, lib/jquery.heatcolor.0.0.1.min" css="common/delaySpinner, common/table, explore/spaces, details/shared">
