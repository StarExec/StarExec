...
%>
<star:template title="upload XML configuration for a job in ${space.name}" css="common/delaySpinner, add/solver" js="common/delaySpinner, lib/jquery.cookie, lib/jquery.validate.min, add/batchJob">
