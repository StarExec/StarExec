...
public abstract class JobManager {
	...
	private static void buildJob() throws IOException {
		...
		out.write("#!/bin/bash\n"
				...
				+ "	wget \"starexec/starexec/Results?$1\" -o /dev/null  -O /dev/null --spider\n"
				+ "	return $?\n"
				+ "}\n"
				+ "\n"
				+ "function sendResult {\n"
				+ "	toResultServlet \"pid=$1&result=$RESULT&stime=$STIME&mtime=$MTIME\" \n"
				+ "	return $?\n"
				+ "}\n"
				+ "\n"
				+ "function sendJobStatus {\n"
				+ "	toResultServlet \"jid=$JID&status=$1&node=$M\"\n"
				+ "	return $?\n"
				+ "}\n"
				+ "\n"
				+ "# /////////////////////////////////////////////\n"
				...
				+ "echo\n"
				+ "\n"
				+ "sendJobStatus $ST_STA # Signals that job has started to run.\n"
				+ "\n" );
