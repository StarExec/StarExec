...
public class AttributesTableData {
	...
	public AttributesTableData(
			Integer solverId, String solverName, Integer configId, String configName, String attrValue,
			Integer attrCount, Double wallclockSum, Double cpuSum
	) {
	...
	public boolean equals(Object object) {
		if (!(object instanceof AttributesTableData)) {
			...
			return (this.solverId.equals(atd.solverId) && this.solverName.equals(atd.solverName) &&
					this.configId.equals(atd.configId) && this.configName.equals(atd.configName) &&
					this.attrCount.equals(atd.attrCount) && this.attrValue.equals(atd.attrValue));
		}
	}
}
