...
/**
 * Represents a permission between a user and a space, or a default permission on a space. All fields are false by
 * default.
 *
 * @author Tyler Jensen
 */
public class Permission extends Identifiable {
	...
	/**
	 * Gets all the permissions that are turned on, as strings that are recognized by the server
	 *
	 * @return
	 */
