...
public class SolverComparisonComparator implements Comparator<SolverComparison> {
	 ...
	 * 0 Benchmark Name 1 First pair wallclock time OR CPU time, depending on whether  isWallclock is true 2 Second
	 * pair
	 * wallclock time OR CPU time, depending on whether  isWallclock is true 3 Differences between wallclock OR CPU
	 * times, depending on whether isWallclock is true 4 Starexec-result of first pair 5 Starexec-result of second pair
	...
	/**
	 * Compares the solver names of jp1 and jp2 0 = bench name 4 = result 1 5 = result 2
	 *
