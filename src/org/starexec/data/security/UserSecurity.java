...
public class UserSecurity {
	 ...
	 * @return new ValidatorStatusCode(true) if the operation is allowed, and an error code from ValidatorStatusCodes
	 * otherwise
	 */
	 ...
	 * otherwise
	 */
	public static ValidatorStatusCode canUpdateData(
			int userIdBeingUpdated, int userIdCallingUpdate, String attribute, String newVal
	) {
	 ...
	 * @return new ValidatorStatusCode(true) if the operation is allowed and a status code from ValidatorStatusCode
	 * otherwise
	 * @author Albert Giegerich
	 */
	public static ValidatorStatusCode canUserSubscribeOrUnsubscribeUser(
			int userIdBeingUpdated, int userIdMakingRequest
	) {
	 ...
	 * @author Albert Giegerich
	 */
	public static ValidatorStatusCode canUserSubscribeOrUnsubscribeUserToErrorLogs(
			int userIdBeingUpdated, int userIdMakingRequest
	) {
		if (Users.get(userIdBeingUpdated) == null) {
			return new ValidatorStatusCode(false, "The given user could not be found");
	...
	public static ValidatorStatusCode canUserGrantOrSuspendDeveloperPrivileges(
			int userIdToUpdate, int userIdMakingRequest
	) {
