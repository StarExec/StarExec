...
public class SolverTests extends TestSequence {
	...
	protected void teardown() {
		...
		Spaces.removeSubspaces(space1.getId(),Spaces.getParentSpace(space1.getId()),Users.getAdmins().get(0).getId());
		Spaces.removeSubspaces(space2.getId(),Spaces.getParentSpace(space2.getId()),Users.getAdmins().get(0).getId());		
	}
