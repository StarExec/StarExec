...
public class R {
	...
	public static String NODE_OUTPUT_DIR = null;							// The path to the directory on the local node where output shoulld be placed by the user in order to be saved by starexec
