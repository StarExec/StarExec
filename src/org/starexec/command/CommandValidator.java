...
public class CommandValidator {
	...
	private static String[] allowedDownloadParams = new String[] { C.PARAM_ID, C.PARAM_OUTPUT_FILE, C.PARAM_OVERWRITE,
			C.PARAM_LONG_PATH };
	private static String[] allowedDownloadSpaceXMLParams = new String[] { C.PARAM_ID, C.PARAM_OUTPUT_FILE,
			C.PARAM_OVERWRITE, C.PARAM_GET_ATTRIBUTES, C.PARAM_PROCID };

	private static String[] allowedNewDownloadParams = new String[] { C.PARAM_ID, C.PARAM_OUTPUT_FILE,
			C.PARAM_OVERWRITE, C.PARAM_SINCE };
	private static String[] allowedDownloadSpaceParams = new String[] { C.PARAM_ID, C.PARAM_OUTPUT_FILE,
			C.PARAM_OVERWRITE, C.PARAM_EXCLUDE_BENCHMARKS, C.PARAM_EXCLUDE_SOLVERS };
	private static String[] allowedDownloadCSVParams = new String[] { C.PARAM_ID, C.PARAM_OUTPUT_FILE,
			C.PARAM_OVERWRITE, C.PARAM_INCLUDE_IDS, C.PARAM_ONLY_COMPLETED };
	...
	private static String[] allowedCopySpaceParams = new String[] { C.PARAM_TO, C.PARAM_ID, C.PARAM_FROM,
			C.PARAM_COPY_PRIMITIVES };

	private static String[] allowedCopySolverParams = new String[] { C.PARAM_ID, C.PARAM_FROM, C.PARAM_TO,
			C.PARAM_HIERARCHY };
	private static String[] allowedCopyBenchmarkParams = new String[] { C.PARAM_ID, C.PARAM_FROM, C.PARAM_TO };
	private static String[] allowedPollJobParams = new String[] { C.PARAM_OUTPUT_FILE, C.PARAM_ID, C.PARAM_TIME,
			C.PARAM_OVERWRITE };
	...
	private static String[] allowedCreateSubspaceParams = new String[] { C.PARAM_ID, C.PARAM_NAME, C.PARAM_DESC,
			C.PARAM_ENABLE_ALL_PERMISSIONS, "addSolver", "addUser", "addSpace", "addJob", "addBench", "removeSolver",
			"removeUser", "removeSpace", "removeJob", "removeBench" };
	private static String[] allowedCreateJobParams = new String[] { C.PARAM_ID, C.PARAM_NAME, C.PARAM_DESC,
			C.PARAM_WALLCLOCKTIMEOUT, C.PARAM_RESULTS_INTERVAL, C.PARAM_CPUTIMEOUT, C.PARAM_QUEUEID, C.PARAM_PROCID,
			C.PARAM_TRAVERSAL, C.PARAM_MEMORY, C.PARAM_PAUSED, C.PARAM_SEED, C.PARAM_SUPPRESS_TIMESTAMPS };
	private static String[] allowedUploadSolverParams = new String[] { C.PARAM_ID, C.PARAM_TYPE, C.PARAM_PREPROCID,
			C.PARAM_FILE, C.PARAM_URL, C.PARAM_NAME, C.PARAM_DESC, C.PARAM_DESCRIPTION_FILE, C.PARAM_DOWNLOADABLE,
			C.PARAM_RUN, C.PARAM_SETTING };
	private static String[] allowedUploadBenchmarksParams = new String[] { C.PARAM_ID, C.PARAM_BENCHTYPE, C.PARAM_FILE,
			C.PARAM_URL, C.PARAM_DESC, C.PARAM_DESCRIPTION_FILE, C.PARAM_DEPENDENCY, C.PARAM_DOWNLOADABLE,
			C.PARAM_HIERARCHY, C.PARAM_LINKED, C.PARAM_ENABLE_ALL_PERMISSIONS, "addSolver", "addUser", "addSpace",
			"addJob", "addBench", "removeSolver", "removeUser", "removeSpace", "removeJob", "removeBench" };
	private static String[] allowedUploadProcessorParams = new String[] { C.PARAM_ID, C.PARAM_NAME, C.PARAM_DESC,
			C.PARAM_FILE };
	private static String[] allowedUploadConfigParams = new String[] { C.PARAM_FILE, C.PARAM_ID, C.PARAM_FILE,
			C.PARAM_DESC };
	...
	public static int isValidCopyRequest(HashMap<String, String> commandParams, String type) {
		...
		if (!Validator.isValidPosIntegerList(commandParams.get(C.PARAM_ID))
				|| (commandParams.containsKey(C.PARAM_FROM)
						&& !Validator.isValidPosInteger(commandParams.get(C.PARAM_FROM)))
	...
	public static int isValidGetPrimRequest(HashMap<String, String> urlParams, HashMap<String, String> commandParams) {
		if (!paramsExist(new String[] { C.PARAM_ID }, commandParams)
				&& !paramsExist(new String[] { C.PARAM_USER }, commandParams)) {
			return Status.ERROR_MISSING_PARAM;
		}
	...
	public static int isValidCreateJobRequest(HashMap<String, String> commandParams) {
		...
		if (commandParams.containsKey(C.PARAM_TRAVERSAL)) {
			...
			if (!traversalMethod.equals(C.ARG_ROUNDROBIN) && !traversalMethod.equals(C.ARG_DEPTHFIRST)) {
				log.log(traversalMethod + " is not a valid traversal type. Should be one of: " + C.ARG_ROUNDROBIN + ", "
						+ C.ARG_DEPTHFIRST);
