 ...
 * or the execution of a file with line-separated commands.
 * @author Eric
 *
 */
...
public class Shell {
	...
	/**
	 * Initializer simply gets an instance of CommandParser, which is the class responsible for parsing
	 * user commands as Strings
	 */
	public Shell() {
	 ...
	 * @param args Either empty, in which case we should start a shell, or has a single argument, which should be the full path
