...
insert into solvers values (1,1,"test",NOW(),"","",false,1,false,false,1), (2,1,"test2",NOW(),"","",false,1,false,false,1);
insert into configurations values (1,1,"config","",NOW()), (2,2,"config2","",NOW());
insert into solver_assoc values (1,1), (2,1), (1,2),(2,2);
...
insert into benchmarks values (1,1,"bench",null,NOW(),"","",false,1,false,false),(2,1,"bench2",null,NOW(),"","",false,1,false,false);
insert into bench_assoc values(1,1,1);
insert into bench_assoc values(2,1,2);
insert into bench_assoc values(1,2,3);
insert into bench_assoc values(2,2,4);