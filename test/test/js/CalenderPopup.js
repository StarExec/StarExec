...
var MONTH_NAMES = new Array('January',
	'February',
	'March',
	'April',
	'May',
	...
	'Nov',
	'Dec');
var DAY_NAMES = new Array('Sunday',
	'Monday',
	'Tuesday',
	'Wednesday',
	'Thursday',
	...
	while (i_format < format.length) {
		...
		if (token == "yyyy" || token == "yy" || token == "y") {
			...
			if (val.substring(i_val, i_val + 2)
				.toLowerCase() == "am") {ampm = "AM";}
			else if (val.substring(i_val, i_val + 2)
				.toLowerCase() == "pm") {ampm = "PM";}
			else {return 0;}
			i_val += 2;
		}
		else {
...
function CalendarPopup() {
	...
	c.monthNames = new Array("January",
		"February",
		"March",
		"April",
		"May",
		...
		"November",
		"December");
	c.monthAbbreviations = new Array("Jan",
		"Feb",
		"Mar",
		"Apr",
		"May",
...
function CP_refreshCalendar(index) {
	...
	if (arguments.length > 1) {
		calObject.populate(calObject.getCalendar(arguments[1],
			arguments[2],
			arguments[3],
			arguments[4],
			arguments[5]));
		...
		for (var row = 1; row <= 6; row++) {
			...
			for (var col = 1; col <= 7; col++) {
				...
				if (this.disabledDatesExpression != "") {
					var ds = "" + display_year + LZ(display_month) + LZ(
						display_date);
