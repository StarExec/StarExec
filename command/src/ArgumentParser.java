	...
	protected HashMap<Integer,String> getPrimsInSpace(String type,HashMap<String,String> commandParams) {
		...
		try {
			...
			if (commandParams.containsKey(R.PARAM_LIMIT)) {
				return con.getPrimsInSpace(Integer.parseInt(commandParams.get(R.PARAM_ID)), Integer.parseInt(commandParams.get(R.PARAM_LIMIT)), 
						commandParams.containsKey(R.PARAM_USER), type);
			} else {
				return con.getPrimsInSpace(Integer.parseInt(commandParams.get(R.PARAM_ID)), null, 
						commandParams.containsKey(R.PARAM_USER), type);
			}
