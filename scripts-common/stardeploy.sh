...
# Author: Tyler Jensen
# ==============================================================================
# DESCRIPTION: Pulls down starexec trunk, builds it with ant, packages it into
#              a war and deploys it to the server.
# ==============================================================================
...
if [ `hostname` == "stardev.cs.uiowa.edu" ] ; then
	...
	cp stardev.properties deploy.properties
else
	echo "Detected that we are on Production";
	echo "Copying production.properties to local.properties"
	cp production.properties deploy.properties
fi
