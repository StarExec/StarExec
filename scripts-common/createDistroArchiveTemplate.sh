...
DEPLOY_DIR="$STAREXEC_CHECKOUT_DIR/starexec-distro-version-$STAREXEC_VERSION_NUMBER"
ZIP_DIR="$STAREXEC_CHECKOUT_DIR/starexec-distro-version-$STAREXEC_VERSION_NUMBER"
mkdir $DEPLOY_DIR
